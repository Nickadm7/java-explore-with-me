...
import ru.practicum.event.mapper.EventRequestStatusUpdateMapper;
...
import ru.practicum.exception.WrongUpdatedEventException;
...
public class EventServiceImpl implements EventService {
    ...
    public List<EventShortDto> searchEventUseFilter(String text,
        ...
        log.info("Предан запрос на сохранение статистики URL: {}, Addr: {}",
    ...
    public EventFullDto getEventById(Long eventId, HttpServletRequest request) {
        ...
        Map<Long, Long> views = statsClient.getHits(List.of(eventId));
